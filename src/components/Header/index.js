      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div className="collapse navbar-collapse" id="navbarColor01">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <Link to={"experience"} className="nav-link" type="button" spy={true} smooth={true} duration={1000}>Experience</Link>
            </li>
            <li className="nav-item">
              <Link to={"portfolio"} className="nav-link" type="button" spy={true} smooth={true} duration={1000}>Portfolio</Link>
            </li>
            <li className="nav-item">
